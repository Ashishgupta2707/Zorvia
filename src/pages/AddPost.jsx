    ...
    <div className="bg-[#0e0e1c] min-h-screen text-white">
      ...
      <div className="max-w-[1200px] mx-auto px-8 pt-28 pb-20">
        ...
        <div className="au1 flex items-center justify-between flex-wrap gap-4 mb-10">
          ...
          <a
            href="/all-posts"
            className="flex items-center gap-2 text-white/50 hover:text-white text-sm no-underline transition-colors"
          >
            <svg
              width="16"
              height="16"
            ...
            <div className="au3">
              ...
              >
                <input
                  ...
                  className="w-full bg-[#13132a] border border-white/[0.09] rounded-xl px-4 py-3.5 text-white text-sm font-semibold placeholder-white/20 outline-none focus:border-[#7c5cbf]/60 transition-colors"
                />
              </Field>
            </div>
              ...
              <div>
                <div className="flex items-center bg-[#0e0e1c] border border-white/[0.08] rounded-xl overflow-hidden focus-within:border-[#7c5cbf]/50 transition-colors">
                  <input
                    ...
                    className="flex-1 bg-transparent cursor-not-allowed px-3 py-2.5 text-xs text-white placeholder-white/20 outline-none"
                  />
                </div>
              </div>
            </div>
