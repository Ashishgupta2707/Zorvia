        ...
        <div className="flex rounded-2xl overflow-hidden min-h-[580px] shadow-[0_40px_90px_rgba(0,0,0,0.55)]">
          ...
          <div className="flex-1 bg-[#252538] flex flex-col justify-center px-10 py-11">
            ...
            <form onSubmit={handleSubmit(registerForm)}>
              {/* Full name */}
              <div className="au3 grid grid-cols-1 mb-3.5">
              ...
              <span className="text-white/45 text-[13px]">
                ...
                <a
                  href="#"
                  className="text-[#a07de0] no-underline hover:text-[#c4a8f0] transition-colors"
                >
                  Terms &amp; Conditions
                </a>
              </span>
              ...
              <button
                type="submit"
                className="au6 w-full bg-[#7c5cbf] hover:bg-[#6a4caa] text-white font-semibold text-[15px] rounded-xl py-3.5 mb-5 hover:-translate-y-0.5 hover:shadow-[0_4px_16px_rgba(124,92,191,0.45)] active:translate-y-0 transition-all duration-200 cursor-pointer border-none"
              >
                Create account
              </button>
            </form>
