        ...
        <div className="flex rounded-2xl overflow-hidden min-h-[560px] shadow-[0_40px_90px_rgba(0,0,0,0.55)]">
          ...
          <div className="flex-1 bg-[#252538] flex flex-col justify-center px-10 py-12">
            ...
            <p className="au2 text-white/40 text-sm mb-8">
              ...
              <a href="/signup" className="text-[#a07de0] font-medium no-underline hover:text-[#c4a8f0] transition-colors">
                Sign up
              </a>
            </p>
            ...
            <div className="au4 text-right mb-6">
              <a href="#" className="text-[#a07de0] text-[13px] no-underline hover:text-[#c4a8f0] transition-colors">
                Forgot password?
              </a>
            </div>

            {/* Submit */}
            <button className="au5 w-full bg-[#7c5cbf] hover:bg-[#6a4caa] text-white font-semibold text-[15px] rounded-xl py-3.5 mb-5 hover:-translate-y-0.5 hover:shadow-[0_8px_32px_rgba(124,92,191,0.45)] active:translate-y-0 transition-all duration-200 cursor-pointer border-none">
              Log in
            </button>
