  ...
  return (
    <div className="min-h-screen bg-[#1a1a2e] flex items-center justify-center p-6">
      <div className="w-full max-w-[900px]">
        {/* ── Card ── */}
        <div className="flex rounded-2xl overflow-hidden min-h-[560px] shadow-[0_40px_90px_rgba(0,0,0,0.55)]">
          {/* ════════ LEFT IMAGE PANEL ════════ */}
          <div className="hidden md:block relative w-[46%] flex-shrink-0">
            ...
            <div className="absolute top-5 left-5 right-5 flex items-center justify-between">
              <span className="text-white font-bold text-[17px] tracking-widest">
                ZORVIA
              </span>
              <NavLink
                to={"/signup"}
          ...
          {/* ════════ RIGHT FORM PANEL ════════ */}
          <div className="flex-1 bg-[#252538] flex flex-col justify-center px-10 py-12">
            <h1 className="au1 text-white text-3xl font-bold leading-tight mb-1.5">
              Welcome back
            </h1>
            <p className="au2 text-white/40 text-sm mb-8">
              Don't have an account?{" "}
              <Link
                to={"/signup"}
                className="text-[#a07de0] font-medium no-underline hover:text-[#c4a8f0] transition-colors"
              >
                Sign up
              </Link>
            </p>
            ...
            <form onSubmit={handleSubmit(loginSubmit)}>
              ...
              {/* Password */}
              <div className="au4 relative mb-2.5">
                {/* <AuthInput
              ...
              {/* Forgot password */}
              <div className="au4 text-right mb-6">
                <a
                  href="#"
                  className="text-[#a07de0] text-[13px] no-underline hover:text-[#c4a8f0] transition-colors"
                >
                  Forgot password?
                </a>
              </div>
              ...
              <button
                type="submit"
                className="au5 w-full bg-[#7c5cbf] hover:bg-[#6a4caa] text-white font-semibold text-[15px] rounded-xl py-3.5 mb-5 hover:-translate-y-0.5 hover:shadow-[0_4px_16px_rgba(124,92,191,0.45)] active:translate-y-0 transition-all duration-200 cursor-pointer border-none"
              >
                Log in
              </button>
            </form>
            ...
            {/* Divider */}
            <div className="au6 flex items-center gap-3 mb-4">
              <div className="flex-1 h-px bg-white/10" />
              <span className="text-white/35 text-xs">Or login with</span>
              <div className="flex-1 h-px bg-white/10" />
            </div>

            {/* Social buttons */}
            <div className="au7 flex gap-3">
